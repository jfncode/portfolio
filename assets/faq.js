...
window.JFN_FAQ = {
  saudacao:
    'Olá! 👋 Sou o <b>jfncode chatbot</b>. Tiro suas dúvidas sobre sites, sistemas, chatbots e automação — e já te mostro como eu resolvo o seu problema e faço seu negócio vender mais. Escolha uma opção ou digite sua pergunta:',
  ...
  fallback:
    '<span class="gr">// 404 — não achei na minha base</span><br>Essa eu não respondo por aqui 🤔 — mas eu respondo rapidinho no WhatsApp e já te ajudo a resolver. Bora?',

  itens: [
    { id:'servicos', tags:['servico','servicos','oferece','trabalho','portfolio','projetos'],
      pergunta:'Quais serviços você faz',
    ...
    { id:'pagamento', tags:['pagamento','pagar','pix','cartao','parcela','parcelar','forma'],
      ...
      resposta:'💳 Pix, cartão ou parcelado — eu combino o que cabe no seu bolso. O importante é tirar seu projeto do papel. Fala comigo no WhatsApp que monto o melhor formato.', wa:true },

    { id:'whatsapp', tags:['whatsapp','whats','zap','falar','contato','humano','atendente','telefone'],
      pergunta:'Falar no WhatsApp',
      resposta:'🚀 Bora! É só me chamar que eu alinho tudo e seu projeto já entra na fila. Primeira conversa <b>sem compromisso</b>.', wa:true },
  ],
};
